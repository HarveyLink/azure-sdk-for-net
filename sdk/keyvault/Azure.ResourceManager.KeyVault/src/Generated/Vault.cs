...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class Vault : ArmResource
    {
        ...
        public async virtual Task<Response<Vault>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _vaultsRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<Vault> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vaultsRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<VaultDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _vaultsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual VaultDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vaultsRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new VaultDeleteOperation(response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<VaultAccessPolicyParameters>> UpdateAccessPolicyAsync(AccessPolicyUpdateKind operationKind, VaultAccessPolicyProperties properties, CancellationToken cancellationToken = default)
        {
            if (properties == null)
            {
            ...
            try
            {
                var response = await _vaultsRestClient.UpdateAccessPolicyAsync(Id.ResourceGroupName, Id.Name, operationKind, properties, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public virtual Response<VaultAccessPolicyParameters> UpdateAccessPolicy(AccessPolicyUpdateKind operationKind, VaultAccessPolicyProperties properties, CancellationToken cancellationToken = default)
        {
            if (properties == null)
            {
                throw new ArgumentNullException(nameof(properties));
            ...
            try
            {
                var response = _vaultsRestClient.UpdateAccessPolicy(Id.ResourceGroupName, Id.Name, operationKind, properties, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
