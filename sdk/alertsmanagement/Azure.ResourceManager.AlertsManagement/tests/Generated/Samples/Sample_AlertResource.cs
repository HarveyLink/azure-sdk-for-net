...
namespace Azure.ResourceManager.AlertsManagement.Samples
{
    public partial class Sample_AlertResource
    {
        ...
        public async Task Get_GetById()
        {
            ...
            ResourceIdentifier alertResourceId = AlertResource.CreateResourceIdentifier(scope, alertId);
        ...
        public async Task ChangeState_Resolve()
        {
            ...
            AlertResource result = await alert.ChangeStateAsync(newState);
        ...
        public async Task GetEnrichments_Resolve()
        {
            ...
            await foreach (AlertEnrichmentResponse item in alert.GetEnrichmentsAsync())
            {
        ...
        public async Task GetHistory_Resolve()
        {
            ...
            // invoke the operation
            ServiceAlertModification result = await alert.GetHistoryAsync();
