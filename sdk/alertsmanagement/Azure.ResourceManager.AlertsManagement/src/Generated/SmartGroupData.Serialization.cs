...
namespace Azure.ResourceManager.AlertsManagement
{
    public partial class SmartGroupData : IUtf8JsonSerializable, IJsonModel<SmartGroupData>
    {
        ...
        internal static SmartGroupData DeserializeSmartGroupData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<SmartGroupAggregatedProperty> resources = default;
            IReadOnlyList<SmartGroupAggregatedProperty> resourceTypes = default;
            IReadOnlyList<SmartGroupAggregatedProperty> resourceGroups = default;
            IReadOnlyList<SmartGroupAggregatedProperty> monitorServices = default;
            IReadOnlyList<SmartGroupAggregatedProperty> monitorConditions = default;
            IReadOnlyList<SmartGroupAggregatedProperty> alertStates = default;
            IReadOnlyList<SmartGroupAggregatedProperty> alertSeverities = default;
