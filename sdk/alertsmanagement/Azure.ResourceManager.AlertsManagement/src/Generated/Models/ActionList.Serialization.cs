...
{
    public partial class ActionList : IUtf8JsonSerializable, IJsonModel<ActionList>
    {
        ...
        internal static ActionList DeserializeActionList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ActionList(actionGroups ?? new ChangeTrackingList<ActionGroup>(), serializedAdditionalRawData);
        }
