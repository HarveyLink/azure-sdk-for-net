...
{
    public partial class NotificationResult : IUtf8JsonSerializable, IJsonModel<NotificationResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NotificationResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        NotificationResult IJsonModel<NotificationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NotificationResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NotificationResult DeserializeNotificationResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("status"u8))
                {
                    ...
                    status = new ResultStatus(property.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new NotificationResult(statusURL, status, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<NotificationResult>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NotificationResult>)this).GetFormatFromOptions(options) : options.Format;
        ...
        NotificationResult IPersistableModel<NotificationResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NotificationResult>)this).GetFormatFromOptions(options) : options.Format;
