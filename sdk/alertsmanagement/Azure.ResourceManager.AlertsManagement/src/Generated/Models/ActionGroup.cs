...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public partial class ActionGroup
    {
        ...
        internal ActionGroup(string actionGroupId, IDictionary<string, string> webhookProperties, IDictionary<string, string> actionProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ActionGroupId = actionGroupId;
