...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public partial class PrometheusInstantQuery : AlertEnrichmentItem
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="title"/>, <paramref name="description"/>, <paramref name="linkToApi"/>, <paramref name="datasources"/>, <paramref name="grafanaExplorePath"/>, <paramref name="query"/> or <paramref name="time"/> is null. </exception>
        internal PrometheusInstantQuery(string title, string description, Status status, string linkToApi, IEnumerable<string> datasources, string grafanaExplorePath, string query, string time) : base(title, description, status)
        {
            ...
            Query = query;
            Time = time;
            EnrichmentType = Type.PrometheusInstantQuery;
        }
        ...
        /// <param name="query"> The Prometheus expression query. </param>
        /// <param name="time"> The date and the time of the evaluation. </param>
        internal PrometheusInstantQuery(string title, string description, Status status, string errorMessage, Type enrichmentType, IDictionary<string, BinaryData> serializedAdditionalRawData, string linkToApi, IReadOnlyList<string> datasources, string grafanaExplorePath, string query, string time) : base(title, description, status, errorMessage, enrichmentType, serializedAdditionalRawData)
        {
            LinkToApi = linkToApi;
