...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public partial class AlertRuleAnyOfOrLeafCondition : AlertRuleLeafCondition
    {
        ...
        internal AlertRuleAnyOfOrLeafCondition(string field, string equalsValue, IList<string> containsAny, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<AlertRuleLeafCondition> anyOf) : base(field, equalsValue, containsAny, serializedAdditionalRawData)
        {
            AnyOf = anyOf;
        }
