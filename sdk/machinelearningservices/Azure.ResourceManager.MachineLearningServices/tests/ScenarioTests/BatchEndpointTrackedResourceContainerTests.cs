...
namespace Azure.ResourceManager.MachineLearningServices.Tests.ScenarioTests
{
    public class BatchEndpointTrackedResourceContainerTests : MachineLearningServicesManagerTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            BatchEndpointCreateOrUpdateOperation resource = null;
        ...
        public async Task CheckIfExists()
        {
            ...
            Assert.DoesNotThrowAsync(async () => _ = await (await ws.GetBatchEndpointTrackedResources().CreateOrUpdateAsync(
                _resourceName,
