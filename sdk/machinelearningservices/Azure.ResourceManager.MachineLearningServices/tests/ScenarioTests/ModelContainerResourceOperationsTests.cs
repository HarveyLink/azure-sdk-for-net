...
{
    public class ModelContainerResourceOperationsTests : MachineLearningServicesManagerTestBase
    {
        private const string ResourceGroupNamePrefix = "test-ModelContainerResourceOperations";
        ...
        public ModelContainerResourceOperationsTests(bool isAsync)
            : base(isAsync)
        {
        }
        ...
        public async Task Delete()
        {
            ...
            ModelContainerCreateOrUpdateOperation res = null;
            Assert.DoesNotThrowAsync(async () => res = await ws.GetModelContainerResources().CreateOrUpdateAsync(
                deleteResourceName,
                DataHelper.GenerateModelContainerResourceData()));
        ...
        public async Task Get()
        {
            ...
            ModelContainerResource resource = await ws.GetModelContainerResources().GetAsync(_resourceName);
            ModelContainerResource resource1 = await resource.GetAsync();
